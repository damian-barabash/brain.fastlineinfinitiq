...
// Zakładki: Lidzi (tabela + import + historia) / Test rozmowy / Ustawienia (persona, godziny, autopilot).
// Kanały (Resend, WhatsApp, telefon) przeniesione na stronę Integracje — patrz components/SalesChannels.jsx.
        ...
        <label className="f">
          ...
          <div className="chips">
            <button
              ...
              title={channelReady ? '' : 'Najpierw skonfiguruj kanał na stronie Integracje (Resend albo WhatsApp)'}
